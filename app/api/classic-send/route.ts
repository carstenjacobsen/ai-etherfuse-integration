...
import { submitClassicTransaction } from "@/lib/stellar";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await submitClassicTransaction(xdr, network.toUpperCase());
    ...
    console.error("Classic send error:", err);
